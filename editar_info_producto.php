...
<br>
    <div class="container bg-light text-center" style="padding: 30px">
        <h1 class="Titulos"> Actualizar producto </h1>
        <form action="inicio.php" method="POST" id="form_registro_producto" enctype = "multipart/form-data">
        <img src=""  style="border-radius: 50%;"  width = 200px height =200px alt="" id ="iconp" name="foto">
<br>
        Icono: <input type="file" required id="" name="perfil_producto">
        <hr>
